...
const colorString = __webpack_require__(818);
...
const { isLinux, getReport } = __webpack_require__(802);
...
const { safeRe: re, t } = __webpack_require__(765)
...
const parse = __webpack_require__(959)
const { safeRe: re, t } = __webpack_require__(765)
...
var map = {
	"./sharp-linux-arm64v8.node": 173,
	"./sharp-linux-x64.node": 755
};
...
const is = __webpack_require__(419);
...
const color = __webpack_require__(767);
const is = __webpack_require__(419);
...
(__webpack_require__(762).hasVendoredLibvips)();
...
const Sharp = __webpack_require__(955);
__webpack_require__(601)(Sharp);
__webpack_require__(721)(Sharp);
__webpack_require__(551)(Sharp);
__webpack_require__(211)(Sharp);
__webpack_require__(651)(Sharp);
__webpack_require__(63)(Sharp);
__webpack_require__(697)(Sharp);
__webpack_require__(967)(Sharp);
...
const color = __webpack_require__(767);
const is = __webpack_require__(419);
const sharp = __webpack_require__(939);
...
const spawnSync = (__webpack_require__(81).spawnSync);
const semverCoerce = __webpack_require__(38);
const semverGreaterThanOrEqualTo = __webpack_require__(903);

const platform = __webpack_require__(640);
const { config } = __webpack_require__(200);
...
const detectLibc = __webpack_require__(897);
...
const platformAndArch = __webpack_require__(640)();

/* istanbul ignore next */
try {
  module.exports = __webpack_require__(321)(`./sharp-${platformAndArch}.node`);
} catch (err) {
...
const fs = __webpack_require__(147);
const path = __webpack_require__(17);
const events = __webpack_require__(361);
const detectLibc = __webpack_require__(897);
...
try {
  versions = __webpack_require__(471)(`./${versions.vips}/${platformAndArch}/versions.json`);
} catch (_err) { /* ignore */ }
versions.sharp = (__webpack_require__(200).version);
...
var map = {
	"./8.14.2/linux-x64/versions.json": 71,
	"./8.14.3/linux-arm64v8/versions.json": 514
};
...
"use strict";
module.exports = require("./build/Release/sharp-linux-arm64v8.node");
...
"use strict";
module.exports = JSON.parse('{"aom":"3.6.1","archive":"3.7.0","cairo":"1.17.8","cgif":"0.3.2","exif":"0.6.24","expat":"2.5.0","ffi":"3.4.4","fontconfig":"2.14.2","freetype":"2.13.1","fribidi":"1.0.13","gdkpixbuf":"2.42.10","glib":"2.77.0","harfbuzz":"8.0.1","heif":"1.16.2","imagequant":"2.4.1","lcms":"2.15","mozjpeg":"4.1.3","orc":"0.4.34","pango":"1.50.14","pixman":"0.42.2","png":"1.6.40","proxy-libintl":"0.4","rsvg":"2.56.90","spng":"0.7.4","tiff":"4.5.1","vips":"8.14.3","webp":"1.3.1","xml":"2.11.4","zlib-ng":"2.1.3"}');
